#!/usr/bin/env bash
# verify_install.sh — Release-readiness gate for PyAutoLens.
#
# Runs a suite of independent install-path checks (see verify_install.md for
# the full description of each check):
#
