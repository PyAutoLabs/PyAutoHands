...
### `/home/jammy/Code/PyAutoLabs/autogalaxy_workspace_test/scripts/interferometer/modeling_visualization_jit.py` — FAILED (44.9s)
...
```
  ...
  File "/home/jammy/Code/PyAutoLabs/PyAutoFit/autofit/non_linear/search/abstract_search.py", line 685, in start_resume_fit
    samples = self.perform_update(
              ^^^^^^^^^^^^^^^^^^^^
  File "/home/jammy/Code/PyAutoLabs/PyAutoFit/autofit/non_linear/search/abstract_search.py", line 1011, in perform_update
...
- `/home/jammy/Code/PyAutoLabs/autogalaxy_workspace_test/scripts/interferometer/visualization.py` (9.0s)
